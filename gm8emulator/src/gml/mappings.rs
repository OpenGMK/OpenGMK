...
pub const FUNCTIONS: phf::OrderedMap<&'static str, Function> = phf_ordered_map! {
    ...
    "display_get_width" => Function::Engine(Game::display_get_width),
    "display_get_height" => Function::Engine(Game::display_get_height),
    "display_get_colordepth" => Function::Engine(Game::display_get_colordepth),
    "display_get_frequency" => Function::Engine(Game::display_get_frequency),
    ...
    "display_test_all" => Function::Engine(Game::display_test_all),
    "display_reset" => Function::Engine(Game::display_reset),
    "display_mouse_get_x" => Function::Engine(Game::display_mouse_get_x),
    "display_mouse_get_y" => Function::Engine(Game::display_mouse_get_y),
    "display_mouse_set" => Function::Engine(Game::display_mouse_set),
    "window_set_visible" => Function::Engine(Game::window_set_visible),
    "window_get_visible" => Function::Engine(Game::window_get_visible),
    "window_set_fullscreen" => Function::Engine(Game::window_set_fullscreen),
    "window_get_fullscreen" => Function::Engine(Game::window_get_fullscreen),
    "window_set_showborder" => Function::Engine(Game::window_set_showborder),
    "window_get_showborder" => Function::Engine(Game::window_get_showborder),
    "window_set_showicons" => Function::Engine(Game::window_set_showicons),
    "window_get_showicons" => Function::Engine(Game::window_get_showicons),
    "window_set_stayontop" => Function::Engine(Game::window_set_stayontop),
    "window_get_stayontop" => Function::Engine(Game::window_get_stayontop),
    "window_set_sizeable" => Function::Engine(Game::window_set_sizeable),
    "window_get_sizeable" => Function::Engine(Game::window_get_sizeable),
    "window_set_caption" => Function::Engine(Game::window_set_caption),
    "window_get_caption" => Function::Engine(Game::window_get_caption),
    "window_set_cursor" => Function::Engine(Game::window_set_cursor),
    "window_get_cursor" => Function::Engine(Game::window_get_cursor),
    "window_set_color" => Function::Engine(Game::window_set_color),
    "window_get_color" => Function::Engine(Game::window_get_color),
    ...
    "window_get_x" => Function::Engine(Game::window_get_x),
    "window_get_y" => Function::Engine(Game::window_get_y),
    "window_get_width" => Function::Engine(Game::window_get_width),
    "window_get_height" => Function::Engine(Game::window_get_height),
    "window_set_region_size" => Function::Engine(Game::window_set_region_size),
    "window_get_region_width" => Function::Engine(Game::window_get_region_width),
    "window_get_region_height" => Function::Engine(Game::window_get_region_height),
    "window_set_region_scale" => Function::Engine(Game::window_set_region_scale),
    "window_get_region_scale" => Function::Engine(Game::window_get_region_scale),
    "window_mouse_get_x" => Function::Engine(Game::window_mouse_get_x),
    "window_mouse_get_y" => Function::Engine(Game::window_mouse_get_y),
    "window_mouse_set" => Function::Engine(Game::window_mouse_set),
    "window_view_mouse_get_x" => Function::Engine(Game::window_view_mouse_get_x),
    "window_view_mouse_get_y" => Function::Engine(Game::window_view_mouse_get_y),
    "window_view_mouse_set" => Function::Engine(Game::window_view_mouse_set),
    "window_views_mouse_get_x" => Function::Engine(Game::window_views_mouse_get_x),
    "window_views_mouse_get_y" => Function::Engine(Game::window_views_mouse_get_y),
    ...
    "screen_wait_vsync" => Function::Engine(Game::screen_wait_vsync),
    ...
    "draw_get_color" => Function::Engine(Game::draw_get_color),
    "draw_get_alpha" => Function::Engine(Game::draw_get_alpha),
    ...
    "sprite_get_texture" => Function::Engine(Game::sprite_get_texture),
    "background_get_texture" => Function::Engine(Game::background_get_texture),
    "texture_exists" => Function::Engine(Game::texture_exists),
    ...
    "texture_get_width" => Function::Engine(Game::texture_get_width),
    "texture_get_height" => Function::Engine(Game::texture_get_height),
    ...
    "tile_get_x" => Function::Engine(Game::tile_get_x),
    "tile_get_y" => Function::Engine(Game::tile_get_y),
    "tile_get_left" => Function::Engine(Game::tile_get_left),
    "tile_get_top" => Function::Engine(Game::tile_get_top),
    "tile_get_width" => Function::Engine(Game::tile_get_width),
    "tile_get_height" => Function::Engine(Game::tile_get_height),
    "tile_get_depth" => Function::Engine(Game::tile_get_depth),
    "tile_get_visible" => Function::Engine(Game::tile_get_visible),
    "tile_get_xscale" => Function::Engine(Game::tile_get_xscale),
    "tile_get_yscale" => Function::Engine(Game::tile_get_yscale),
    "tile_get_blend" => Function::Engine(Game::tile_get_blend),
    "tile_get_alpha" => Function::Engine(Game::tile_get_alpha),
    "tile_get_background" => Function::Engine(Game::tile_get_background),
    ...
    "tile_find" => Function::Engine(Game::tile_find),
    "tile_exists" => Function::Engine(Game::tile_exists),
    ...
    "tile_layer_find" => Function::Engine(Game::tile_layer_find),
    ...
    "surface_create_ext" => Function::Engine(Game::surface_create_ext),
    "surface_free" => Function::Engine(Game::surface_free),
    "surface_exists" => Function::Engine(Game::surface_exists),
    "surface_get_width" => Function::Engine(Game::surface_get_width),
    "surface_get_height" => Function::Engine(Game::surface_get_height),
    ...
    "action_highscore" => Function::Engine(Game::action_highscore),
    ...
    "action_end_sound" => Function::Engine(Game::action_end_sound),
    "action_if_sound" => Function::Engine(Game::action_if_sound),
    ...
    "action_if_previous_room" => Function::Engine(Game::action_if_previous_room),
    "action_if_next_room" => Function::Engine(Game::action_if_next_room),
    ...
    "action_show_info" => Function::Engine(Game::action_show_info),
    "action_show_video" => Function::Engine(Game::action_show_video),
    "action_splash_video" => Function::Engine(Game::action_splash_video),
    ...
    "action_end_game" => Function::Engine(Game::action_end_game),
    "action_restart_game" => Function::Engine(Game::action_restart_game),
    "action_save_game" => Function::Engine(Game::action_save_game),
    "action_load_game" => Function::Engine(Game::action_load_game),
    ...
    "action_if" => Function::Engine(Game::action_if),
    "action_if_number" => Function::Engine(Game::action_if_number),
    ...
    "action_highscore_clear" => Function::Engine(Game::action_highscore_clear),
    "action_set_life" => Function::Runtime(Game::action_set_life),
    "action_if_life" => Function::Engine(Game::action_if_life),
    ...
    "action_set_health" => Function::Engine(Game::action_set_health),
    "action_if_health" => Function::Engine(Game::action_if_health),
    ...
    "action_cd_play" => Function::Engine(Game::action_cd_play),
    "action_cd_stop" => Function::Engine(Game::action_cd_stop),
    "action_cd_pause" => Function::Engine(Game::action_cd_pause),
    "action_cd_resume" => Function::Engine(Game::action_cd_resume),
    "action_cd_present" => Function::Engine(Game::action_cd_present),
    "action_cd_playing" => Function::Engine(Game::action_cd_playing),
    ...
    "random_get_seed" => Function::Engine(Game::random_get_seed),
    ...
    "instance_find" => Function::Engine(Game::instance_find),
    "instance_exists" => Function::Runtime(Game::instance_exists),
    "instance_number" => Function::Runtime(Game::instance_number),
    "instance_position" => Function::Engine(Game::instance_position),
    "instance_nearest" => Function::Engine(Game::instance_nearest),
    "instance_furthest" => Function::Engine(Game::instance_furthest),
    ...
    "room_previous" => Function::Engine(Game::room_previous),
    "room_next" => Function::Engine(Game::room_next),
    ...
    "YoYo_GetPlatform" => Function::Engine(Game::yoyo_getplatform),
    "YoYo_GetDevice" => Function::Engine(Game::yoyo_getdevice),
    "YoYo_OpenURL" => Function::Engine(Game::yoyo_openurl),
    "YoYo_OpenURL_ext" => Function::Engine(Game::yoyo_openurl_ext),
    "YoYo_OpenURL_full" => Function::Engine(Game::yoyo_openurl_full),
    "YoYo_GetDomain" => Function::Constant(Game::yoyo_getdomain),
    "YoYo_GetTimer" => Function::Engine(Game::yoyo_gettimer),
    "YoYo_AddVirtualKey" => Function::Engine(Game::yoyo_addvirtualkey),
    "YoYo_DeleteVirtualKey" => Function::Engine(Game::yoyo_deletevirtualkey),
    "YoYo_ShowVirtualKey" => Function::Engine(Game::yoyo_showvirtualkey),
    "YoYo_HideVirtualKey" => Function::Engine(Game::yoyo_hidevirtualkey),
    ...
    "file_exists" => Function::Engine(Game::file_exists),
    "file_delete" => Function::Engine(Game::file_delete),
    "file_rename" => Function::Engine(Game::file_rename),
    "file_copy" => Function::Engine(Game::file_copy),
    "directory_exists" => Function::Engine(Game::directory_exists),
    "directory_create" => Function::Engine(Game::directory_create),
    ...
    "file_attributes" => Function::Engine(Game::file_attributes),
    ...
    "parameter_count" => Function::Engine(Game::parameter_count),
    "parameter_string" => Function::Engine(Game::parameter_string),
    "environment_get_variable" => Function::Engine(Game::environment_get_variable),
    "registry_write_string" => Function::Engine(Game::registry_write_string),
    "registry_write_real" => Function::Engine(Game::registry_write_real),
    "registry_read_string" => Function::Engine(Game::registry_read_string),
    "registry_read_real" => Function::Engine(Game::registry_read_real),
    "registry_exists" => Function::Engine(Game::registry_exists),
    "registry_write_string_ext" => Function::Engine(Game::registry_write_string_ext),
    "registry_write_real_ext" => Function::Engine(Game::registry_write_real_ext),
    "registry_read_string_ext" => Function::Engine(Game::registry_read_string_ext),
    "registry_read_real_ext" => Function::Engine(Game::registry_read_real_ext),
    "registry_exists_ext" => Function::Engine(Game::registry_exists_ext),
    ...
    "ini_read_string" => Function::Engine(Game::ini_read_string),
    "ini_read_real" => Function::Engine(Game::ini_read_real),
    "ini_write_string" => Function::Engine(Game::ini_write_string),
    "ini_write_real" => Function::Engine(Game::ini_write_real),
    "ini_key_exists" => Function::Engine(Game::ini_key_exists),
    "ini_section_exists" => Function::Engine(Game::ini_section_exists),
    "ini_key_delete" => Function::Engine(Game::ini_key_delete),
    "ini_section_delete" => Function::Engine(Game::ini_section_delete),
    "disk_free" => Function::Engine(Game::disk_free),
    "disk_size" => Function::Engine(Game::disk_size),
    ...
    "highscore_value" => Function::Engine(Game::highscore_value),
    "highscore_name" => Function::Engine(Game::highscore_name),
    ...
    "keyboard_get_numlock" => Function::Engine(Game::keyboard_get_numlock),
    ...
    "keyboard_check" => Function::Engine(Game::keyboard_check),
    "keyboard_check_pressed" => Function::Engine(Game::keyboard_check_pressed),
    "keyboard_check_released" => Function::Engine(Game::keyboard_check_released),
    "keyboard_check_direct" => Function::Engine(Game::keyboard_check_direct),
    "mouse_check_button" => Function::Engine(Game::mouse_check_button),
    "mouse_check_button_pressed" => Function::Engine(Game::mouse_check_button_pressed),
    "mouse_check_button_released" => Function::Engine(Game::mouse_check_button_released),
    "mouse_wheel_up" => Function::Engine(Game::mouse_wheel_up),
    "mouse_wheel_down" => Function::Engine(Game::mouse_wheel_down),
    ...
    "mplay_connect_status" => Function::Engine(Game::mplay_connect_status),
    ...
    "mplay_session_name" => Function::Engine(Game::mplay_session_name),
    "mplay_session_join" => Function::Engine(Game::mplay_session_join),
    "mplay_session_status" => Function::Engine(Game::mplay_session_status),
    "mplay_session_end" => Function::Engine(Game::mplay_session_end),
    "mplay_player_find" => Function::Engine(Game::mplay_player_find),
    "mplay_player_name" => Function::Engine(Game::mplay_player_name),
    "mplay_player_id" => Function::Engine(Game::mplay_player_id),
    ...
    "mplay_message_send" => Function::Engine(Game::mplay_message_send),
    "mplay_message_send_guaranteed" => Function::Engine(Game::mplay_message_send_guaranteed),
    "mplay_message_receive" => Function::Engine(Game::mplay_message_receive),
    "mplay_message_id" => Function::Engine(Game::mplay_message_id),
    "mplay_message_value" => Function::Engine(Game::mplay_message_value),
    "mplay_message_player" => Function::Engine(Game::mplay_message_player),
    "mplay_message_name" => Function::Engine(Game::mplay_message_name),
    "mplay_message_count" => Function::Engine(Game::mplay_message_count),
    ...
    "external_call" => Function::Engine(Game::external_call),
    ...
    "window_handle" => Function::Engine(Game::window_handle),
    "show_debug_message" => Function::Engine(Game::show_debug_message),
    "set_program_priority" => Function::Engine(Game::set_program_priority),
    "set_application_title" => Function::Engine(Game::set_application_title),
    "variable_global_exists" => Function::Engine(Game::variable_global_exists),
    "variable_global_get" => Function::Engine(Game::variable_global_get),
    "variable_global_array_get" => Function::Engine(Game::variable_global_array_get),
    "variable_global_array2_get" => Function::Engine(Game::variable_global_array2_get),
    ...
    "clipboard_has_text" => Function::Engine(Game::clipboard_has_text),
    "clipboard_set_text" => Function::Engine(Game::clipboard_set_text),
    "clipboard_get_text" => Function::Engine(Game::clipboard_get_text),
    "date_current_datetime" => Function::Engine(Game::date_current_datetime),
    "date_current_date" => Function::Engine(Game::date_current_date),
    "date_current_time" => Function::Engine(Game::date_current_time),
    "date_create_datetime" => Function::Engine(Game::date_create_datetime),
    "date_create_date" => Function::Engine(Game::date_create_date),
    "date_create_time" => Function::Engine(Game::date_create_time),
    "date_valid_datetime" => Function::Engine(Game::date_valid_datetime),
    "date_valid_date" => Function::Engine(Game::date_valid_date),
    "date_valid_time" => Function::Engine(Game::date_valid_time),
    "date_inc_year" => Function::Engine(Game::date_inc_year),
    "date_inc_month" => Function::Engine(Game::date_inc_month),
    "date_inc_week" => Function::Engine(Game::date_inc_week),
    "date_inc_day" => Function::Engine(Game::date_inc_day),
    "date_inc_hour" => Function::Engine(Game::date_inc_hour),
    "date_inc_minute" => Function::Engine(Game::date_inc_minute),
    "date_inc_second" => Function::Engine(Game::date_inc_second),
    "date_get_year" => Function::Engine(Game::date_get_year),
    "date_get_month" => Function::Engine(Game::date_get_month),
    "date_get_week" => Function::Engine(Game::date_get_week),
    "date_get_day" => Function::Engine(Game::date_get_day),
    "date_get_hour" => Function::Engine(Game::date_get_hour),
    "date_get_minute" => Function::Engine(Game::date_get_minute),
    "date_get_second" => Function::Engine(Game::date_get_second),
    "date_get_weekday" => Function::Engine(Game::date_get_weekday),
    "date_get_day_of_year" => Function::Engine(Game::date_get_day_of_year),
    "date_get_hour_of_year" => Function::Engine(Game::date_get_hour_of_year),
    "date_get_minute_of_year" => Function::Engine(Game::date_get_minute_of_year),
    "date_get_second_of_year" => Function::Engine(Game::date_get_second_of_year),
    "date_year_span" => Function::Engine(Game::date_year_span),
    "date_month_span" => Function::Engine(Game::date_month_span),
    "date_week_span" => Function::Engine(Game::date_week_span),
    "date_day_span" => Function::Engine(Game::date_day_span),
    "date_hour_span" => Function::Engine(Game::date_hour_span),
    "date_minute_span" => Function::Engine(Game::date_minute_span),
    "date_second_span" => Function::Engine(Game::date_second_span),
    "date_compare_datetime" => Function::Engine(Game::date_compare_datetime),
    "date_compare_date" => Function::Engine(Game::date_compare_date),
    "date_compare_time" => Function::Engine(Game::date_compare_time),
    "date_date_of" => Function::Engine(Game::date_date_of),
    "date_time_of" => Function::Engine(Game::date_time_of),
    "date_datetime_string" => Function::Engine(Game::date_datetime_string),
    "date_date_string" => Function::Engine(Game::date_date_string),
    "date_time_string" => Function::Engine(Game::date_time_string),
    "date_days_in_month" => Function::Engine(Game::date_days_in_month),
    "date_days_in_year" => Function::Engine(Game::date_days_in_year),
    "date_leap_year" => Function::Engine(Game::date_leap_year),
    "date_is_today" => Function::Engine(Game::date_is_today),
    "sprite_name" => Function::Engine(Game::sprite_name),
    "sprite_exists" => Function::Engine(Game::sprite_exists),
    "sprite_get_name" => Function::Engine(Game::sprite_get_name),
    "sprite_get_number" => Function::Engine(Game::sprite_get_number),
    "sprite_get_width" => Function::Engine(Game::sprite_get_width),
    "sprite_get_height" => Function::Engine(Game::sprite_get_height),
    "sprite_get_xoffset" => Function::Engine(Game::sprite_get_xoffset),
    "sprite_get_yoffset" => Function::Engine(Game::sprite_get_yoffset),
    "sprite_get_bbox_left" => Function::Engine(Game::sprite_get_bbox_left),
    "sprite_get_bbox_right" => Function::Engine(Game::sprite_get_bbox_right),
    "sprite_get_bbox_top" => Function::Engine(Game::sprite_get_bbox_top),
    "sprite_get_bbox_bottom" => Function::Engine(Game::sprite_get_bbox_bottom),
    ...
    "sprite_set_cache_size" => Function::Engine(Game::sprite_set_cache_size),
    "sprite_set_cache_size_ext" => Function::Engine(Game::sprite_set_cache_size_ext),
    "background_name" => Function::Engine(Game::background_name),
    "background_exists" => Function::Engine(Game::background_exists),
    "background_get_name" => Function::Engine(Game::background_get_name),
    "background_get_width" => Function::Engine(Game::background_get_width),
    "background_get_height" => Function::Engine(Game::background_get_height),
    ...
    "sound_name" => Function::Engine(Game::sound_name),
    "sound_exists" => Function::Engine(Game::sound_exists),
    "sound_get_name" => Function::Engine(Game::sound_get_name),
    "sound_get_kind" => Function::Engine(Game::sound_get_kind),
    "sound_get_preload" => Function::Engine(Game::sound_get_preload),
    ...
    "font_name" => Function::Engine(Game::font_name),
    "font_exists" => Function::Engine(Game::font_exists),
    "font_get_name" => Function::Engine(Game::font_get_name),
    "font_get_fontname" => Function::Engine(Game::font_get_fontname),
    "font_get_size" => Function::Engine(Game::font_get_size),
    "font_get_bold" => Function::Engine(Game::font_get_bold),
    "font_get_italic" => Function::Engine(Game::font_get_italic),
    "font_get_first" => Function::Engine(Game::font_get_first),
    "font_get_last" => Function::Engine(Game::font_get_last),
    ...
    "script_name" => Function::Engine(Game::script_name),
    "script_exists" => Function::Engine(Game::script_exists),
    "script_get_name" => Function::Engine(Game::script_get_name),
    "script_get_text" => Function::Engine(Game::script_get_text),
    "script_execute" => Function::Runtime(Game::script_execute),
    "path_name" => Function::Engine(Game::path_name),
    "path_exists" => Function::Engine(Game::path_exists),
    "path_get_name" => Function::Engine(Game::path_get_name),
    "path_get_length" => Function::Engine(Game::path_get_length),
    "path_get_kind" => Function::Engine(Game::path_get_kind),
    "path_get_closed" => Function::Engine(Game::path_get_closed),
    "path_get_precision" => Function::Engine(Game::path_get_precision),
    "path_get_number" => Function::Engine(Game::path_get_number),
    "path_get_point_x" => Function::Engine(Game::path_get_point_x),
    "path_get_point_y" => Function::Engine(Game::path_get_point_y),
    "path_get_point_speed" => Function::Engine(Game::path_get_point_speed),
    "path_get_x" => Function::Engine(Game::path_get_x),
    "path_get_y" => Function::Engine(Game::path_get_y),
    "path_get_speed" => Function::Engine(Game::path_get_speed),
    ...
    "timeline_name" => Function::Engine(Game::timeline_name),
    "timeline_exists" => Function::Engine(Game::timeline_exists),
    "timeline_get_name" => Function::Engine(Game::timeline_get_name),
    ...
    "object_name" => Function::Engine(Game::object_name),
    "object_exists" => Function::Engine(Game::object_exists),
    "object_get_name" => Function::Engine(Game::object_get_name),
    "object_get_sprite" => Function::Engine(Game::object_get_sprite),
    "object_get_solid" => Function::Engine(Game::object_get_solid),
    "object_get_visible" => Function::Engine(Game::object_get_visible),
    "object_get_depth" => Function::Engine(Game::object_get_depth),
    "object_get_persistent" => Function::Engine(Game::object_get_persistent),
    "object_get_mask" => Function::Engine(Game::object_get_mask),
    "object_get_parent" => Function::Engine(Game::object_get_parent),
    "object_is_ancestor" => Function::Engine(Game::object_is_ancestor),
    ...
    "room_name" => Function::Engine(Game::room_name),
    "room_exists" => Function::Engine(Game::room_exists),
    "room_get_name" => Function::Engine(Game::room_get_name),
    ...
    "part_type_exists" => Function::Engine(Game::part_type_exists),
    ...
    "part_type_color" => Function::Engine(Game::part_type_color),
    ...
    "part_type_alpha" => Function::Engine(Game::part_type_alpha),
    ...
    "part_system_exists" => Function::Engine(Game::part_system_exists),
    ...
    "part_particles_count" => Function::Engine(Game::part_particles_count),
    ...
    "part_emitter_exists" => Function::Engine(Game::part_emitter_exists),
    ...
    "part_attractor_exists" => Function::Engine(Game::part_attractor_exists),
    ...
    "part_destroyer_exists" => Function::Engine(Game::part_destroyer_exists),
    ...
    "part_deflector_exists" => Function::Engine(Game::part_deflector_exists),
    ...
    "part_changer_exists" => Function::Engine(Game::part_changer_exists),
    ...
    "ds_stack_size" => Function::Engine(Game::ds_stack_size),
    "ds_stack_empty" => Function::Engine(Game::ds_stack_empty),
    "ds_stack_push" => Function::Engine(Game::ds_stack_push),
    "ds_stack_pop" => Function::Engine(Game::ds_stack_pop),
    "ds_stack_top" => Function::Engine(Game::ds_stack_top),
    "ds_stack_write" => Function::Engine(Game::ds_stack_write),
    ...
    "ds_queue_size" => Function::Engine(Game::ds_queue_size),
    "ds_queue_empty" => Function::Engine(Game::ds_queue_empty),
    "ds_queue_enqueue" => Function::Engine(Game::ds_queue_enqueue),
    "ds_queue_dequeue" => Function::Engine(Game::ds_queue_dequeue),
    "ds_queue_head" => Function::Engine(Game::ds_queue_head),
    "ds_queue_tail" => Function::Engine(Game::ds_queue_tail),
    "ds_queue_write" => Function::Engine(Game::ds_queue_write),
    ...
    "ds_list_size" => Function::Engine(Game::ds_list_size),
    "ds_list_empty" => Function::Engine(Game::ds_list_empty),
    ...
    "ds_list_find_index" => Function::Engine(Game::ds_list_find_index),
    "ds_list_find_value" => Function::Engine(Game::ds_list_find_value),
    "ds_list_sort" => Function::Engine(Game::ds_list_sort),
    "ds_list_shuffle" => Function::Engine(Game::ds_list_shuffle),
    "ds_list_write" => Function::Engine(Game::ds_list_write),
    ...
    "ds_map_size" => Function::Engine(Game::ds_map_size),
    "ds_map_empty" => Function::Engine(Game::ds_map_empty),
    ...
    "ds_map_exists" => Function::Engine(Game::ds_map_exists),
    "ds_map_find_value" => Function::Engine(Game::ds_map_find_value),
    "ds_map_find_previous" => Function::Engine(Game::ds_map_find_previous),
    "ds_map_find_next" => Function::Engine(Game::ds_map_find_next),
    "ds_map_find_first" => Function::Engine(Game::ds_map_find_first),
    "ds_map_find_last" => Function::Engine(Game::ds_map_find_last),
    "ds_map_write" => Function::Engine(Game::ds_map_write),
    ...
    "ds_priority_size" => Function::Engine(Game::ds_priority_size),
    "ds_priority_empty" => Function::Engine(Game::ds_priority_empty),
    ...
    "ds_priority_find_priority" => Function::Engine(Game::ds_priority_find_priority),
    ...
    "ds_priority_find_min" => Function::Engine(Game::ds_priority_find_min),
    "ds_priority_delete_max" => Function::Engine(Game::ds_priority_delete_max),
    "ds_priority_find_max" => Function::Engine(Game::ds_priority_find_max),
    "ds_priority_write" => Function::Engine(Game::ds_priority_write),
    ...
    "ds_grid_width" => Function::Engine(Game::ds_grid_width),
    "ds_grid_height" => Function::Engine(Game::ds_grid_height),
    ...
    "ds_grid_get" => Function::Engine(Game::ds_grid_get),
    "ds_grid_get_sum" => Function::Engine(Game::ds_grid_get_sum),
    "ds_grid_get_max" => Function::Engine(Game::ds_grid_get_max),
    "ds_grid_get_min" => Function::Engine(Game::ds_grid_get_min),
    "ds_grid_get_mean" => Function::Engine(Game::ds_grid_get_mean),
    "ds_grid_get_disk_sum" => Function::Engine(Game::ds_grid_get_disk_sum),
    "ds_grid_get_disk_max" => Function::Engine(Game::ds_grid_get_disk_max),
    "ds_grid_get_disk_min" => Function::Engine(Game::ds_grid_get_disk_min),
    "ds_grid_get_disk_mean" => Function::Engine(Game::ds_grid_get_disk_mean),
    "ds_grid_value_exists" => Function::Engine(Game::ds_grid_value_exists),
    "ds_grid_value_x" => Function::Engine(Game::ds_grid_value_x),
    "ds_grid_value_y" => Function::Engine(Game::ds_grid_value_y),
    "ds_grid_value_disk_exists" => Function::Engine(Game::ds_grid_value_disk_exists),
    "ds_grid_value_disk_x" => Function::Engine(Game::ds_grid_value_disk_x),
    "ds_grid_value_disk_y" => Function::Engine(Game::ds_grid_value_disk_y),
    "ds_grid_shuffle" => Function::Engine(Game::ds_grid_shuffle),
    "ds_grid_write" => Function::Engine(Game::ds_grid_write),
    ...
    "sound_isplaying" => Function::Engine(Game::sound_isplaying),
    ...
    "cd_init" => Function::Engine(Game::cd_init),
    "cd_present" => Function::Engine(Game::cd_present),
    "cd_number" => Function::Engine(Game::cd_number),
    "cd_playing" => Function::Engine(Game::cd_playing),
    "cd_paused" => Function::Engine(Game::cd_paused),
    "cd_track" => Function::Engine(Game::cd_track),
    "cd_length" => Function::Engine(Game::cd_length),
    "cd_track_length" => Function::Engine(Game::cd_track_length),
    "cd_position" => Function::Engine(Game::cd_position),
    "cd_track_position" => Function::Engine(Game::cd_track_position),
    "cd_play" => Function::Engine(Game::cd_play),
    "cd_stop" => Function::Engine(Game::cd_stop),
    "cd_pause" => Function::Engine(Game::cd_pause),
    "cd_resume" => Function::Engine(Game::cd_resume),
    "cd_set_position" => Function::Engine(Game::cd_set_position),
    "cd_set_track_position" => Function::Engine(Game::cd_set_track_position),
    "cd_open_door" => Function::Engine(Game::cd_open_door),
    "cd_close_door" => Function::Engine(Game::cd_close_door),
    "MCI_command" => Function::Engine(Game::mci_command),
    ...
    "d3d_transform_stack_empty" => Function::Engine(Game::d3d_transform_stack_empty),
