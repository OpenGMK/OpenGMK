        ...
        for i in 0..self.capacity {
            unsafe {
                cimgui_sys::igPushStyleColorVec4(
                    cimgui_sys::ImGuiCol__ImGuiCol_Button as _,
                    cimgui_sys::ImVec4 { x: 0.98, y: 0.59, z: 0.26, w: 0.4 });
                cimgui_sys::igPushStyleColorVec4(
            ...
            if info.frame.button(&self.save_text[i], imgui::Vec2(60.0, 20.0), Some(imgui::Vec2(4.0, y)))
                && *info.game_running
            {
