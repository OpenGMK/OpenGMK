...
pub fn unpack(data: &mut io::Cursor<&mut [u8]>, max_size: u32, disk_offset: u32) -> io::Result<Vec<u8>> {
    info!("Unpacking UPX with output size {}, data starting at {}", max_size, disk_offset);
